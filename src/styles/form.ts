...
export const titleStyle: string =
    'text-[50px] text-paragraph font-medium text-center pb-[50px]'

//-----Text Field
export const fieldTextStyle: string =
    'block py-[25px] px-[33px] text-[20px] text-gray_50 bg-white rounded-[10px] outline-none'
